...
object SDTStage3 : Initable {
    ...
    val task5_1 = MachineTask(
        ...
        createTaskSymbol(Material.DIAMOND_BLOCK, "§d壕，效率至上！", "§6用4个钻石块§e替换§6原来的红石块","§6再用扳手敲击活板门，就能完成升级","§e中间一定不能碰活板门！","§7(否则只能重新构建羊毛筛子)","§b升级后筛矿速度大大提升","§b爆率略微增加","§e筛沙砾有10%几率掉青金石","§e筛沙子有1%几率掉绿宝石","§e筛粘土有25%几率掉荧石粉","§e筛灵魂沙有1%几率掉恶魂之泪","§e有5%几率掉下界合金碎片"),
    ...
    val task6_3 = ItemTask(
        ...
        8 orderWith 4, task6_1,
        createTaskSymbol(Material.NETHER_WART, "§d用钻石筛子筛下界岩(地狱岩)来获得", "§e下界疣(地狱疣) 绯红菌 诡异菌"),
